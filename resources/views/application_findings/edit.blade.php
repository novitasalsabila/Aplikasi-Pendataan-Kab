<x-app-layout>
    <div class="max-w-4xl mx-auto py-8 px-6">
        <h2 class="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-100">✏️ Edit Temuan Aplikasi</h2>
        ...
        <form action="{{ route('application_findings.update', $finding->id) }}" method="POST"
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full border rounded p-2 dark:bg-gray-700">{{ old('description', $finding->description) }}</textarea>
            </div>
