                ...
                <tbody>
                    @forelse ($versions as $index => $ver)
                        <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900">
                            ...
                            <td class="px-4 py-2">{{ $ver->release_date ? \Carbon\Carbon::parse($ver->release_date)->format('d M Y') : '-' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-3 text-center text-gray-500">Belum ada data versi aplikasi.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
