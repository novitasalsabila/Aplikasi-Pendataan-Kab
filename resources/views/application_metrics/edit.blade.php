    ...
    <div class="max-w-3xl mx-auto py-8 px-6 md:mt-0 sm:mt-20">
        <form action="{{ route('application_metrics.update', $metric->id) }}" method="POST"
            ...
            <div class="relative mb-6">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Tambah Monitoring Baru</h1>
                    <p class="text-sm text-gray-500 -mt-1 mb-10">
                        Lengkapi informasi Monitoring di bawah ini
                    </p>
            ...
            <div>
                ...
                <input type="datetime-local" name="check_date"
                       ...
                       required class="w-full border rounded p-2 text-gray-600">
            </div>
            ...
            <div>
                ...
                <textarea name="note" rows="3"
                          class="w-full border rounded p-2 text-gray-600">{{ $metric->note }}</textarea>
            </div>
